...
clear
echo -e ""
toilet --filter metal 'WHATSAPP NUMBER BANNED'
sleep 7
echo -e "             $white  coded by$blue ${underline}Mr.XDark-Screm"
echo ""
}
banner
menu()
...
ip(){
read -p "[×]ENTER VICTIM's NUMBER(with +62): " wifi
}
if [ $op==1 ]
then
	clear
	sleep 6 && clear
        clear
        toilet -f future "WHATSAPP NUMBER BANNED"
	echo "Code staring...."
	sleep 2
	ip
	loading
